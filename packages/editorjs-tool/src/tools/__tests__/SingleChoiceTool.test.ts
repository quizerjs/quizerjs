...
describe('SingleChoiceTool', () => {
  ...
  describe('构造函数', () => {
    ...
    it('应该使用提供的数据创建实例', () => {
      ...
      expect(tool['data'].question.text).toBe('测试单选题');
  ...
  describe('render', () => {
    ...
    it('应该包含 quiz-question-header 组件', () => {
      const tool = new SingleChoiceTool({});
      const element = tool.render();
      const header = element.querySelector('quiz-question-header');
    ...
    it('应该包含 quiz-question-description 组件', () => {
      const tool = new SingleChoiceTool({});
      const element = tool.render();
      const description = element.querySelector('quiz-question-description');
    ...
    it('应该包含 quiz-option-list 组件', () => {
      const tool = new SingleChoiceTool({});
      const element = tool.render();
      const optionList = element.querySelector('quiz-option-list');
