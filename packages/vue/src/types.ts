...
export interface QuizComponentEmits {
  (e: 'submit', answers: Record<string, any>, score: number): void;
  (e: 'answer-change', questionId: string, answer: any): void;
}
