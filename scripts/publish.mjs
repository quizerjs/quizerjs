  ...
  const prePublishTasks = new Listr(
    [
      ...
      },
      {
        ...
        task: () => {
          const builds = [
            ['@quizerjs/dsl', 'packages/dsl/dist'],
            ['@quizerjs/core', 'packages/core/dist'],
            ['@quizerjs/quizerjs', 'packages/quizerjs/dist'],
            ['@quizerjs/react', 'packages/react/dist'],
            ['@quizerjs/vue', 'packages/vue/dist'],
            ['@quizerjs/svelte', 'packages/svelte/dist'],
            ['@quizerjs/editorjs-tool', 'packages/editorjs-tool/dist'],
            ['@quizerjs/theme', 'packages/theme/dist'],
          ];
